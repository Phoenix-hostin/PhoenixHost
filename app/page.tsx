            ...
            <div className="max-w-6xl mx-auto">
              ...
              >
                ...
                <div className="flex items-baseline gap-2 mb-4">
                  <span className="text-white text-4xl font-bold">₹350</span>
                  <span className="text-gray-300">per month</span>
                </div>
                <Button className="bg-[#7c3aed] hover:bg-[#6d28d9] text-white px-8 py-3 text-lg rounded-full transition-all duration-300 hover:scale-105">
                  SEE MORE
                </Button>
              </motion.div>
            </div>
